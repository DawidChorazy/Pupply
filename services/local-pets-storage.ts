...
type LocalPetPayload = Omit<CreatePetPayload, "photoKey"> & {
  photoUrl?: string;
};
...
export function createLocalPet(payload: LocalPetPayload): Pet {
...
export function updateLocalPet(pet: Pet, payload: LocalPetPayload): Pet {
  return {
    ...pet,
    name: payload.name,
    age: payload.age ?? null,
